                ...
                if (isset($results)&& $results != null) {
                    for($k=0;$k<sizeof($results);$k++){?>
                        <tr>
                            ...
                            <td><a href="<?php echo $baseUrl."/openmrs/delete?url=".$patients_url.$results[$k]['uuid']."?purge" ?>" class="btn btn-danger"
                                   id = "delete_patient">Delete</a></td>
                            <td width="400px"> <a href="#"><?php $k++; echo $results[$k]['display']?></a></td>
                            <td><a href="<?php echo $baseUrl."/openmrs/delete?url=".$patients_url.$results[$k]['uuid']."?purge" ?>" class="btn btn-danger"
                                   id = "delete_patient">Delete</a></td>
